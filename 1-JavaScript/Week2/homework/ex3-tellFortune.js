...
function main() {
  ...
  const partnerNames = ['Bob', 'Rob', 'Charlie', 'Ethan', 'Solomon'];

  const locations = ['New York', 'London', 'Paris', 'Holland', 'Sydney'];

  const jobTitles = ['Doctor', 'Nurse', 'Teacher', 'Web Developer', 'Painter'];
